...
export function resolvePerFileUploadLimit(_maxFileSizeMb?: number | null, _isStaff = false): PerFileUploadLimit {
  void _maxFileSizeMb
  void _isStaff
  return { unlimited: true }
}

export function perFileUploadLimitLabel(_limit?: PerFileUploadLimit): string {
