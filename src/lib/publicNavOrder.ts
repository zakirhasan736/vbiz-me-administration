/**
 * Default create-card / builder tab order (same sequence as CREATE_CARD_DEFAULT_TABS, without pinned ends).
 * This is an ORDERING template only — selected/AI tabs are filtered to this sequence; missing ids are skipped.
 * Never treat this list as “enable all”.
 */
