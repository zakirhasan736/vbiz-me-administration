...
export function parseMyInfoJson(raw?: string | null): VCardMyInfo {
  ...
  try {
    ...
    return {
      headline: asText(o.headline, DEFAULT_VCARD_MY_INFO.headline),
      ...
      callLabel: asText(o.callLabel, DEFAULT_VCARD_MY_INFO.callLabel),
      textLabel: asText(o.textLabel, DEFAULT_VCARD_MY_INFO.textLabel),
      emailLabel: asText(o.emailLabel, DEFAULT_VCARD_MY_INFO.emailLabel),
