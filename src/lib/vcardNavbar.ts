...
const NAV_ITEM_DEFS: NavBarNavItem[] = [
  ...
  { id: 'booking', label: 'Booking', icon: CalendarDays, profileContent: 'calendar', editorPanel: { kind: 'empty' } },
  ...
  { id: 'events', label: 'Events', icon: Ticket, profileContent: 'calendar', editorPanel: { kind: 'empty' } },
  ...
  { id: 'who-we-are', label: 'Who We Are', icon: Landmark, profileContent: 'mission', editorPanel: { kind: 'empty' } },
]
