    ...
    <div className="flex items-center gap-2 border-b border-slate-200/50 px-2 py-2 sm:px-4 dark:border-white/5">
      ...
      {showRemove && onRemove ? (
        <button
          ...
          className="mr-2 flex shrink-0 cursor-pointer items-center gap-2 rounded-xl bg-red-50 px-3 py-2.5 font-bold text-red-500 opacity-0 transition-all group-hover/card:opacity-100 hover:bg-red-100 hover:text-red-600 focus:opacity-100 sm:px-4 dark:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-500/20"
          title="Remove Entry"
        >
