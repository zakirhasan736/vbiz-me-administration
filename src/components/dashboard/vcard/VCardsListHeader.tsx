...
export function VCardsListHeader({
  ...
  return (
    <div className="mb-8 space-y-5">
      <div className="relative overflow-hidden rounded-4xl border border-slate-200/80 bg-white p-6 shadow-sm sm:p-8 dark:border-white/10 dark:bg-[#0b0f19]">
        <div className="pointer-events-none absolute top-0 right-0 h-64 w-64 bg-violet-500/5 blur-[100px]" />
        <div className="relative z-10 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          ...
          {canCreate ? (
            ...
            <button
              type="button"
              disabled
              title={createDisabledReason || 'Card limit reached'}
              data-tour-id="tour-create-vcard"
