      ...
      <Table>
        <TableHeader className="bg-slate-50/50 dark:bg-white/2">
          <TableRow className="border-0 hover:bg-transparent dark:hover:bg-transparent">
            <TableHead className="px-8 tracking-widest">Event</TableHead>
            <TableHead className="px-8 tracking-widest">Viewer</TableHead>
            <TableHead className="px-8 tracking-widest">Time</TableHead>
            <TableHead className="px-8 text-right tracking-widest">Platform</TableHead>
          </TableRow>
        </TableHeader>
