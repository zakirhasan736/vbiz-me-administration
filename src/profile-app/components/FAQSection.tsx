        ...
        <div className="flex flex-col gap-3">
          <div className={`${headerClass} p-5 shadow-sm`}>
            ...
            <div className="relative mb-3">
              <Search className="pointer-events-none absolute top-1/2 left-3.5 h-3.5 w-3.5 -translate-y-1/2 text-(--vbiz-text-muted)" />
              <input
                type="text"
          ...
          {filteredFaqs.length === 0 ? (
            <div className={`${itemClass} flex flex-col items-center justify-center border-dashed p-8 text-center`}>
              ...
              {filteredFaqs.map((faq, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`relative overflow-hidden rounded-2xl border transition-all duration-300 ${itemClass} ${
                      isOpen ? 'border-gold scale-[1.01] shadow-md' : 'opacity-90'
                    }`}
                  >
            ...
            <div className="relative z-10">
              ...
              <div className="relative max-w-md">
                ...
                <input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="vbiz-modal-input focus:border-gold w-full rounded-xl border py-3 pr-4 pl-11 text-sm font-semibold focus:outline-none"
                />
              </div>
            </div>
          </div>
            ...
            {filteredFaqs.map((faq, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group relative overflow-hidden shadow-sm transition-all duration-500 ${itemClass} ${
                    isOpen ? 'border-gold/40' : 'hover:border-gold/20'
                  }`}
                >
