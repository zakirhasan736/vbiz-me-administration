/** Public-card popup layout: ~5% top/bottom inset, max 90% height, vertically centered. */
export const PUBLIC_MODAL_INSET_Y =
  'pt-[max(5dvh,env(safe-area-inset-top,0px))] pb-[max(5dvh,env(safe-area-inset-bottom,0px))]'
...
export const PUBLIC_MODAL_PANEL =
  'flex max-h-[90dvh] w-full flex-col overflow-x-hidden overflow-y-auto overscroll-contain rounded-2xl border shadow-2xl'
